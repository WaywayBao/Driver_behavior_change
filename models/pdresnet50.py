...
model_urls = {
    'pdresnet18': '',
    'pdresnet34': '',
    'pdresnet50': '/home/waywaybao_cs10/Desktop/risk_object_identification-master/models/model_best.pth',
...
def pdresnet50(pretrained=False, **kwargs):
    ...
    # pretrained = False
    if pretrained:
        state_dict_pdresnet50 = torch.load(model_urls['pdresnet50'])['state_dict']
